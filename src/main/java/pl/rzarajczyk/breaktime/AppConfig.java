...
////
////    @Bean
////    public java.util.List<MenuItem> menuItems() {
////        java.util.List<MenuItem> items = new java.util.ArrayList<>();
////        items.add(menuActionPause());
////        items.add(menuActionShowTimer());
////        items.add(menuActionShowSettings());
////        items.add(menuActionAbout());
////        items.add(menuActionExit());
////        return items;
////    }
////
////    @Bean
